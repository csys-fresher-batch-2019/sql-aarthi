create table tasks(task_no number,task_name varchar2(40),name varchar2(25),deadline date,completed_on date,status char(1),constraint task_no-pk primary key(task_no));
